...
function SignupBox({ setBox }) {
  ...
  return (
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="w-half bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          ...
          <h2 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
            ...
            >
              ...
              <button
                ...
                className="w-full h-10 text-white bg-red-800 rounded-lg"
              >
                Create an account
              </button>
